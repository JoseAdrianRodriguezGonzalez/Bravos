...
<body>
    ...
    <main class="main">
        <section class="section1">
            Para todo contacto, están presente los siguientes números y direcciones:
            <ul class="ul-1">
                <li> Whatsapp: +52 1 464 103 0201</li>
                <li>Instagram: bravos.boots.and.hats</li>
                <li>Correo: bravosboots.hats@gmail.com</li>
            </ul>
        Nos encontramos en :
            Tampico #704-A colonia Bellavista, Salamanca Guanajuato
        </section>

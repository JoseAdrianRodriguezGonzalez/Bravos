<!--Este documento hace lo mismo que el index.php y tiene el mimso código que html, existe para cuando dicho documento se transporte por otra sección de la web-->
...
<head>
    ...
    <link rel="stylesheet" href="/Principal_es/style.css">
...
<body>
    <header class="header">
        ...
        <div class="arriba">
            ...
            <div class="compra">
                ...
                <a href="/Principal_es/perfil/index.php" id="padrea">    
    ...
    <main class="main">
        <div class="principal">
            <div class="video">
                <video src="/assets/1.webm" autoplay class="anima" id="animacion" muted></video>
            </div>
            <div class="slider">
                <div class="seccion-mayor">
                    <div class="izquierda" id="izq">
                        <i class="icon-left-open"></i>
                    </div>
                    <div class="derecha" id="der">
                        <i class="icon-right-open"> </i>
                    </div>
                    <div class="grupo" id="gr">
                        <div class="slider_img">
                            <img src="/assets/125135518_2431598677147715_6916784770905023585_n.jpg" alt="" class="img1">
                        </div>
                        <div class="slider_img">
                            <img src="/assets/125466609_2754776524763220_8808154597673108430_n.jpg" alt="" class="img2">
                        </div>
                        <div class="slider_img">
                            <img src="/assets/327558168_434039925607049_9047715595502178664_n.jpg" alt="" class="img3">
                        </div>
                        <div class="slider_img">
                            <img src="/assets/337356908_1008031226851427_8913446080003794759_n.webp" alt="" class="img4">
                        </div>
                        <div class="slider_img">
                            <img src="/assets/337689622_606819744687795_4463476993346729155_n.webp" alt="" class="img5">
                        </div>
                        <div class="slider_img">
                            <img src="/assets/337757825_1594528537706105_8451762593925764760_n.webp" alt="" class="img6">
                        </div>
                    </div>
                </div>
            </div>
            <section class="seccion">
                ...
                <div class="ropa">
                    ...
                    <a href="#" class="l1">
                    <div class="sombreros2" >
                        <img src="/assets/337648911_748493476899811_8730901925126939753_n.webp" alt="" class="img7">
                        
                    </div>
                    <span class="text1">SOMBREROS</span>
                </a>
                ...
                <div class="instagram-qr">
                    <a href="https://www.instagram.com/bravos.boots.and.hats">
                        <img src="/assets/instagram.jpg" alt="" class="insta">
                    </a>
                </div>
        </section>
        </div>
    ...
    <footer class="footer">
        ...
        <a href="/Principal_es/Inicio/sesion/logout.php">cerrar sesión</a>
    </footer>
    <?php
